function Top (rt) {
  ...
  this.gensym156 = ($env) => {
    ...
    if (_val_0) {
      const _val_5 = $env.clientBob52.val;
      const _vlev_6 = $env.clientBob52.lev;
  ...
  this.gensym156.serialized = "";
  this.gensym156.framesize = 0;
  this.clientBob52 = ($env) => {
    let _T = rt.runtime.$t
    let _STACK = _T.callStack
    let _SP = _T._sp
    let _SP_OLD
    ...
    _T.boundSlot =  _SP + 7
    const gensym144$$$const = rt.mkLabel("{bob}")
    const gensym143$$$const = "Bob"
    const gensym141$$$const = 2001
    const gensym139$$$const = false
    const gensym135$$$const = "beer"
    const gensym136$$$const = "winter"
    ...
    const clientBob_arg153 = rt.constructLVal (_$reg0_val,_$reg0_lev,_$reg0_tlev);
    _STACK[ _SP + 3] =  clientBob_arg153
    ...
    _STACK[_SP - 4] = _T.pc;
    _STACK[_SP - 3] = this.$$$clientBob52$$$kont3
  ...
  this.clientBob52.deps = [];
  this.clientBob52.libdeps = [];
  this.clientBob52.serialized = "";
  this.clientBob52.framesize = 7;
  this.agent43 = ($env) => {
    let _T = rt.runtime.$t
    let _STACK = _T.callStack
    let _SP = _T._sp
    ...
    const gensym111$$$const = rt.mkLabel("{bob}")
    const _$reg0_val = _T.r0_val;
    let _$reg0_lev = _T.pc;
    let _$reg0_tlev = _T.pc;
    let _pc_init = _T.pc;
  ...
  this.agent43.serialized = "";
  ...
  this.main = ($env) => {
    ...
    $$$env17.print2 = print2;
    $$$env17.__dataLevel =  rt.join (agent43.dataLevel,print2.dataLevel);
    const clientBob52 = rt.mkVal(rt.RawClosure($$$env17, this, this.clientBob52))
    $$$env17.clientBob52 = clientBob52;
    $$$env17.clientBob52.selfpointer = true;
    _STACK[ _SP + 0] =  clientBob52
  ...
  this.main.deps = ['print2', 'printWithLabels3', 'printString4', 'loop23', 'agent43', 'clientBob52', 'gensym156'];
  this.main.libdeps = [];
  this.main.serialized = "";
  this.main.framesize = 1;
  this.$$$clientBob52$$$kont0 = () => {
    let _T = rt.runtime.$t
    let _STACK = _T.callStack
    let _SP = _T._sp
    let _SP_OLD
    ...
    const clientBob_arg153 = _STACK[ _SP + -10]
    ...
    const _raw_121 = rt.mkTuple([clientBob_arg153, gensym129]);
  ...
  this.$$$clientBob52$$$kont0.debugname = "$$$clientBob52$$$kont0"
  this.$$$clientBob52$$$kont1 = () => {
    let _T = rt.runtime.$t
    let _STACK = _T.callStack
    let _SP = _T._sp
    let _SP_OLD
  ...
  this.$$$clientBob52$$$kont1.debugname = "$$$clientBob52$$$kont1"
  this.$$$clientBob52$$$kont2 = () => {
    let _T = rt.runtime.$t
    let _STACK = _T.callStack
    let _SP = _T._sp
    let _SP_OLD
    ...
    _STACK[_SP - 5] = _SP_OLD;
    _STACK[_SP - 4] = _T.pc;
    _STACK[_SP - 3] = this.$$$clientBob52$$$kont1
    _STACK[_SP - 2] = _T.mailbox.mclear;
    _STACK[_SP - 1] = false;
    _T._sp = _SP;
    if (! _STACK[ _SP + -6] ) {
  ...
  this.$$$clientBob52$$$kont2.debugname = "$$$clientBob52$$$kont2"
  this.$$$clientBob52$$$kont3 = () => {
    let _T = rt.runtime.$t
    let _STACK = _T.callStack
    let _SP = _T._sp
    let _SP_OLD
    ...
    _STACK[_SP - 5] = _SP_OLD;
    _STACK[_SP - 4] = _T.pc;
    _STACK[_SP - 3] = this.$$$clientBob52$$$kont2
    _STACK[_SP - 2] = _T.mailbox.mclear;
    _STACK[_SP - 1] = false;
    _T._sp = _SP;
    _SP_OLD = _SP; 
    ...
    _STACK[_SP - 5] = _SP_OLD;
    _STACK[_SP - 4] = _T.pc;
    _STACK[_SP - 3] = this.$$$clientBob52$$$kont0
    _STACK[_SP - 2] = _T.mailbox.mclear;
    _STACK[_SP - 1] = false;
    _T._sp = _SP;
    if (! _STACK[ _SP + -11] ) {
  ...
  this.$$$clientBob52$$$kont3.debugname = "$$$clientBob52$$$kont3"
  this.$$$gensym49$$$kont5 = () => {
    let _T = rt.runtime.$t
    let _STACK = _T.callStack
    let _SP = _T._sp
  ...
  this.$$$main$$$kont20 = () => {
    ...
    const gensym161$$$const = "QmNzXPVyMYojkfP8JjVqwy4NWbqYyovThEk3bkK4t4Ny6a"
    const gensym162$$$const = "datingServer"
    const clientBob52 = _STACK[ _SP + 0]
    ...
    $$$env18.clientBob52 = clientBob52;
    $$$env18.$decltemp$75 = $decltemp$75;
    $$$env18.__dataLevel =  rt.join (clientBob52.dataLevel,$decltemp$75.dataLevel);
